...
import com.duha.foodordering.Adapter.DetailPageSliderPagerAdapter;
import com.duha.foodordering.Adapter.DetailPageVariantAdapter;
import com.duha.foodordering.Adapter.DotsAdapter;
import com.duha.foodordering.Adapter.MyPagerAdapter;
...
import com.duha.foodordering.Activities.ProductExtra;
                ...
                new Callback<AddToWishlistResponse>() {
                    ...
                    public void success(AddToWishlistResponse addToWishlistResponse, Response response) {
                        ...
                        if (addToWishlistResponse.getSuccess().equalsIgnoreCase("true")) {
                            ...
                            alertDialog.setConfirmText("Verifique Ahora");
