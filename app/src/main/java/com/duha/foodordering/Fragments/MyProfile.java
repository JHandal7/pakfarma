package com.duha.foodordering.Fragments;
...
import com.duha.foodordering.Activities.AccountVerification;
import com.duha.foodordering.Extras.Common;
import com.duha.foodordering.Extras.Config;
import com.duha.foodordering.Activities.Login;
import com.duha.foodordering.MVP.SignUpResponse;
import com.duha.foodordering.MVP.UserProfileResponse;
import com.duha.foodordering.Activities.MainActivity;
import com.duha.foodordering.R;
import com.duha.foodordering.Retrofit.Api;
import com.duha.foodordering.Activities.SignUp;
import com.duha.foodordering.Activities.SplashScreen;
...
public class MyProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MainActivity.title.setText("Mi Perfil");
    ...
    private void  setUserProfileData() {
        ...
        // editTexts.get(1).setText(userProfileResponseData.getFlat()); ruc
        // editTexts.get(2).setText(userProfileResponseData.getLocality()); direccion y #
        //editTexts.get(3).setText(userProfileResponseData.getState());
        editTexts.get(2).setText(userProfileResponseData.getCity());
        //editTexts.get(4).setText(userProfileResponseData.getCity());
        //editTexts.get(5).setText(userProfileResponseData.getState());
        //        editTexts.get(6).setText(userProfileResponseData.getPincode());
        ...
        if (editText.getText().toString().trim().length() > 0) {
            if (SplashScreen.restaurantDetailResponseData.getDeliverycity().contains(editText.getText().toString().trim()))
                ...
                Config.showPincodeCustomAlertDialog(getActivity(),
                        "No atendemos su distrito",
                        "Por el momento no hacemos delivery en su distrito.",
